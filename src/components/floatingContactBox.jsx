...
const FloatingContactBox = ({ showContact }) => {
  return (
    showContact && (
      <div className="fixed bottom-10 right-4 w-72 p-4 bg-[#004D40] text-white rounded-lg shadow-lg transform transition-all duration-300 ease-in-out opacity-100 scale-100 z-50">
